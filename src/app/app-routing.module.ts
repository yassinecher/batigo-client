...
const routes: Routes = [
  ...
  { path: 'incident',    canActivate: [AuthGuard],
    component: FullComponent, loadChildren: () => import('./back/incident/incident.module').then(m => m.IncidentModule) },


  { path: 'inspections', canActivate: [AuthGuard],
    component: FullComponent, loadChildren: () => import('./back/inspections/inspections.module').then(m => m.InspectionsModule) },
];
